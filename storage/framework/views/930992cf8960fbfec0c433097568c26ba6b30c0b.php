               ...
               <?php endif; ?>
                  ...
                  <div class="form-row">
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" name="entry_firstname" class="form-control field-validate" required id="entry1_firstname" <?php if(!empty($result['editAddress'])): ?> value="<?php echo e($result['editAddress'][0]->firstname); ?>" <?php endif; ?>>
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" name="entry_lastname" class="form-control field-validate" required id="entry1_lastname" <?php if(!empty($result['editAddress'])): ?> value="<?php echo e($result['editAddress'][0]->lastname); ?>" <?php endif; ?>>
                  ...
                  <div class="form-row">
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" name="entry_street_address" required class="form-control field-validate" id="entry1_street_address" <?php if(!empty($result['editAddress'])): ?> value="<?php echo e($result['editAddress'][0]->street); ?>" <?php endif; ?>>
                  ...
                  <div class="form-row">
                    ...
                    <div class="form-group select-control col-md-6">
                      ...
                      <input type="text" name="entry_city" required class="form-control field-validate" id="entry_city1" <?php if(!empty($result['editAddress'])): ?> value="<?php echo e($result['editAddress'][0]->city); ?>" <?php endif; ?>>
                  ...
                  <div class="form-row">
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" name="entry_postcode" required class="form-control field-validate" id="entry_postcode1" <?php if(!empty($result['editAddress'])): ?> value="<?php echo e($result['editAddress'][0]->postcode); ?>" <?php endif; ?>>
...
<?php echo $__env->make('web.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\sites\laravel-ecommerce-universal v4.0.12 preinstalled\resources\views/web/shipping.blade.php ENDPATH**/ ?>