                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group" id="imageIcone">
                                                <label for="name"
                                                       class="col-sm-2 col-md-4 control-label"><?php echo e(trans('labels.Image')); ?></label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10 col-md-8 float-right">
                                                <a type="button" class="btn btn-default float-right"
                                                   href="<?php echo e(url('admin/products/images/display')); ?>/<?php echo e($products_id); ?>"><?php echo e(trans('labels.back')); ?> </a>
                                                <button type="submit"
                                                        class="btn btn-primary float-right"><?php echo e(trans('labels.AddNew')); ?></button>
                                            </div>
                                            <br><br><br><br><br>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\sites\mysan\resources\views/admin/products/images/add.blade.php ENDPATH**/ ?>