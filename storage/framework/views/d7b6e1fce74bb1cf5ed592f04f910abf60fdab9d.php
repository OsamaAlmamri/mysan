...
//  id.push(jQuery('.test_image').attr("image_id"));
        ...
        $("#btn").click(function () {
            ...
            if (confirm('Are You Sure To Delete This?')) {
                ...
                if (imgs > 0) {
                    $.ajax({
                        url: 'http://laravel0.themes-coder.net/admin/media/delete',
                        type: "POST",
                        data: formData,
...
//alert('.attributeid_'+options_id);
            ...
            $.ajax({
                url: 'http://laravel0.themes-coder.net/admin/products/attach/attribute/default/options/currentstock',
                type: "POST",
                data: formData,
                dataType: "json",
                success: function (res) {
...
//add-inventory
        $(document).on('click', '#add-inventory', function (e) {
            var formData = $('#addewinventoryfrom').serialize();
            $.ajax({
                url: 'http://laravel0.themes-coder.net/admin/addnewstock',
                type: "POST",
                data: formData,
                success: function (res) {
...
//ajax call for add option value
        $(document).on('click', '.add-value', function (e) {
            ...
            var formData = parentFrom.serialize();
            $.ajax({
                url: 'http://laravel0.themes-coder.net/admin/products/attributes/options/values/addattributevalue',
                type: "POST",
                data: formData,
                success: function (res) {
                    $("#loader").hide();
...
//ajax call for add option value
        $(document).on('click', '.update-value', function (e) {
            ...
            $.ajax({
                url: 'http://laravel0.themes-coder.net/admin/products/attributes/options/values/updateattributevalue',
                type: "POST",
                data: formData,
                success: function (res) {
                    $("#loader").hide();
...
//deleteattribute
        $(document).on('click', '#deleteAttribute', function (e) {
            ...
            var formData = parentFrom.serialize();
            $.ajax({
                url: 'http://laravel0.themes-coder.net/admin/products/attributes/options/values/delete',
                type: "POST",
                data: formData,
                success: function (res) {
                    $('.addError').hide();
...
//ajax call for submit value
        $(document).on('click', '#addAttribute', function (e) {
            ...
            $.ajax({
                url: 'http://laravel0.themes-coder.net/admin/products/attach/attribute/default/options/add',
                type: "POST",
                data: formData,
                success: function (res) {
                    $("#loader").hide();
...
//ajax call for submit value
        $(document).on('click', '#addDefaultAttribute', function (e) {
            ...
            $.ajax({
                url: 'http://laravel0.themes-coder.net/admin/products/attach/attribute/default',
                type: "POST",
                data: formData,
                success: function (res) {
                    $("#loader").hide();
...
//onchange get zones agains country
        $(document).on('change', '#entry_country_id', function (e) {
            ...
            $.ajax({
                url: "http://laravel0.themes-coder.net/admin/getZones",
                dataType: 'json',
                type: "post",
// data: '&zone_country_id='+zone_country_id,
                data: {
                    "_token": "19CHnbRpxZYjMLtIfsjycPUCufMLYdu8cTcp8JFl",
...
//$(this).next(".error-content").addClass('hidden');
            ...
            if (error == "") {
                $.ajax({
                    url: "http://laravel0.themes-coder.net/admin/customers/addcustomeraddress",
                    type: "POST",
                    data: formData,
                    async: false,
                    success: function (res) {
...
//editAddressModal
        $(document).on('click', '.editAddressModal', function () {
            ...
            $.ajax({
                url: "http://laravel0.themes-coder.net/admin/customers/editaddress",
                type: "POST",
...
//editproductattributemodal
        $(document).on('click', '.editproductattributemodal', function () {
            ...
            $.ajax({
                url: 'http://laravel0.themes-coder.net/admin/products/attach/attribute/default/options/edit',
                type: "POST",
...
//editdefaultattributemodal
        $(document).on('click', '.editdefaultattributemodal', function () {
            ...
            var options_id = $(this).attr('options_id');
            $.ajax({
                url: "http://laravel0.themes-coder.net/admin/products/attach/attribute/default/edit",
                type: "POST",
                data: '&products_id=' + products_id + '&products_attributes_id=' + products_attributes_id + '&language_id=' + language_id + '&options_id=' + options_id,
                success: function (data) {
...
//$(this).next(".error-content").addClass('hidden');
            ...
            if (error == "") {
                ...
                $.ajax({
                    url: "http://laravel0.themes-coder.net/admin/customers/updateaddress",
                    type: "POST",
                    data: formData,
        ...
        $(document).on('click', '#updateProductAttribute', function (e) {
            ...
            $.ajax({
                url: 'http://laravel0.themes-coder.net/admin/products/attach/attribute/default/options/update',
                type: "POST",
                data: formData,
                success: function (res) {
                    $("#loader").hide();
        ...
        $(document).on('click', '#updateDefaultAttribute', function (e) {
            ...
            $.ajax({
                url: "http://laravel0.themes-coder.net/admin/products/attach/attribute/default/update",
                type: "POST",
                data: formData,
                success: function (res) {
                    $("#loader").hide();
...
// 	$.ajax({
// 		url: "http://laravel0.themes-coder.net/admin/customers/deleteAddress",
// 		type: "POST",
// 		data: formData,
// 		success: function (res) {
...
//deleteproductattributemodal
        $(document).on('click', '.deleteproductattributemodal', function () {
            ...
            var products_attributes_id = $(this).attr('products_attributes_id');
            $.ajax({
                url: "http://laravel0.themes-coder.net/admin/products/attach/attribute/default/options/showdeletemodal",
                type: "POST",
                data: '&products_id=' + products_id + '&products_attributes_id=' + products_attributes_id,
                success: function (data) {
                    $('.deleteEmbed').html(data);
...
//deletedefaultattributemodal
        $(document).on('click', '.deletedefaultattributemodal', function () {
            ...
            var products_attributes_id = $(this).attr('products_attributes_id');
            $.ajax({
                url: "http://laravel0.themes-coder.net/admin/products/attach/attribute/default/deletedefaultattributemodal",
                type: "POST",
                data: '&products_id=' + products_id + '&products_attributes_id=' + products_attributes_id,
                success: function (data) {
...
//deleteOption
        $(document).on('click', '.deleteOption', function () {
            ...
            $.ajax({
                url: "http://laravel0.themes-coder.net/admin/products/attributes/options/values/checkattributeassociate",
                type: "POST",
...
//alert(delete_language_id);
            $.ajax({
                url: "http://laravel0.themes-coder.net/admin/products/attributes/options/values/checkvalueassociate",
                type: "POST",
...
//deleteProductAttribute
        $(document).on('click', '#deleteProductAttribute', function () {
            ...
            console.log(formData);
            $.ajax({
                url: "http://laravel0.themes-coder.net/admin/products/attach/attribute/default/delete",
                type: "POST",
                data: formData,
                success: function (res) {
                    $("#loader").hide();
...
//ajax call for submit value
        $(document).on('click', '#addImage', function (e) {
            ...
            $.ajax({
                url: 'http://laravel0.themes-coder.net/admin/addnewproductimage',
                type: "POST",
                data: formData,
                success: function (res) {
                    if (res.length != '') {
                        ...
                        for (i = 0; i < res.length; ++i) {
                            var j = i + 1;
                            showData[i] = "<tr><td>" + j + "</td><td><img src=http://laravel0.themes-coder.net//" + res[i].image + " alt='' width=' 100px'></td><td>" + res[i].htmlcontent + "</td> <td><a products_id = '" + res[i].products_id + "' class='badge bg-light-blue editProductImagesModal' id = '" + res[i].id + "' ><i class='fa fa-pencil-square-o' aria-hidden='true'></i></a> <a class='badge bg-red deleteProductImagesModal' id = '" + res[i].id + "' products_id = '" + res[i].products_id + "' ><i class='fa fa-trash' aria-hidden='true'></i></a></td></tr>";
                        }
...
//$('.applied_message').attr('hidden','hidden');
            ...
            $.ajax({
                url: 'http://laravel0.themes-coder.net/admin/updateWebTheme',
                type: "POST",
...
//editproductimagesmodal
        $(document).on('click', '.editProductImagesModal', function () {
            ...
            var products_id = $(this).attr('products_id');
            $.ajax({
                url: 'http://laravel0.themes-coder.net/admin/editproductimage',
                type: "POST",
        ...
        $(document).on('click', '#updateProductImage', function (e) {
            ...
            $.ajax({
                url: "http://laravel0.themes-coder.net/admin/updateproductimage",
                type: "POST",
                data: formData,
                success: function (res) {
                    $("#loader").hide();
        ...
        $("#sendNotificaionForm").submit(function () {
            ...
            $.ajax({
                url: "http://laravel0.themes-coder.net/admin/devices/notifyUser",
                type: "POST",
                data: formData,
...
//deleteProductImagesModal
        $(document).on('click', '.deleteProductImagesModal', function () {
            ...
            var products_id = $(this).attr('products_id');
            $.ajax({
                url: 'http://laravel0.themes-coder.net/admin/products/images/deleteproductimagemodal',
                type: "POST",
                data: '&products_id=' + products_id + '&id=' + id,
                success: function (data) {
...
//deleteproductimage
        $(document).on('click', '#deleteProductImage', function () {
            ...
            $.ajax({
                url: "http://laravel0.themes-coder.net/admin/products/images/deleteproductimage",
                type: "POST",
                data: formData,
                success: function (res) {
                    $("#loader").hide();
...
//ajax call for notification pop
        $(document).on('click', '#notification-popup', function () {
            var customers_id = $(this).attr('customers_id');
            $.ajax({
                url: 'http://laravel0.themes-coder.net/admin/devices/customerNotification',
                type: "POST",
...
//ajax call for manage role
        $(document).on('click', '.manage-role-popup', function () {
            ...
            $.ajax({
                url: 'http://laravel0.themes-coder.net/admin/managerolepopup',
                type: "POST",
                data: '&customers_id=' + customers_id,
                success: function (data) {
...
//get products for coupon
        $(document).on('focus', '.couponProdcuts input', function () {
            ...
            $.ajax({
                url: "http://laravel0.themes-coder.net/admin/couponProducts",
                type: "POST",
                data: '',
                success: function (data) {
                },
...
//getRange
        $(document).on('click', '.getRange', function () {
            ...
            if (dateRange != '') {
                ...
                dateRange = dateRange.replace(/ /g, "");
                window.location = "http://laravel0.themes-coder.net/admin/dashboard/dateRange=" + dateRange;
            } else {
...
//default_method
        $(document).on('click', '.default_method', function () {
            ...
            $.ajax({
                url: 'http://laravel0.themes-coder.net/admin/defaultShippingMethod',
                type: "POST",
...
//default_language
        $(document).on('click', '.default_language', function () {
            ...
            $.ajax({
                url: 'http://laravel0.themes-coder.net/admin/languages/default',
                type: "POST",
        ...
        $(document).on('click', '.default_pay_method', function () {
            ...
            $.ajax({
                url: 'http://laravel0.themes-coder.net/admin/paymentmethods/active',
                type: "POST",
    ...
    // 	$.ajax({
    // 		url: 'http://laravel0.themes-coder.net/admin/getOptions',
    // 		type: "POST",
    // 		data: '&languages_id='+languages_id,
    // 		success: function (data) {
    ...
    function getOptionsValue(option_id) {
        ...
        $.ajax({
            url: 'http://laravel0.themes-coder.net/admin/products/attach/attribute/default/options/getOptionsValue',
            type: "POST",
    ...
    function getSubCategory() {
        ...
        var getCategories = 'http://laravel0.themes-coder.net/admin/getajaxcategories';
...
//$(this).next(".error-content").removeClass('hidden');
    ...
    $(document).on('click', '#generate-key', function (e) {
        ...
        $.ajax({
            url: 'http://laravel0.themes-coder.net/admin/generateKey',
            type: "GET",
            async: false,
            success: function (res) {
                $("#loader").hide();
    ...
    $(document).on('change', '.product-type', function () {
        ...
        $.ajax({
            url: 'http://laravel0.themes-coder.net/admin/products/inventory/ajax_min_max' + '/' + product_id,
            type: "GET",
            success: function (res) {
//console.log(res.products[0].products_type);
        ...
        $.ajax({
            url: 'http://laravel0.themes-coder.net/admin/products/inventory/ajax_attr' + '/' + product_id,
            type: "GET",
            success: function (res) {
//console.log(res);
                $('#attribute').html(res);
...
// a.className = "thumb-url btn btn-primary";
                a.setAttribute('data-clipboard-text', 'http://laravel0.themes-coder.net/admin/media/uploadimage' + '/' + response);
// a.innerHTML = "copy url";
    ...
    $(document).ready(function () {
        $("#myModaldetail").on("show.bs.modal", function (e) {
            ...
            $.get("http://laravel0.themes-coder.net/admin/detailimage" + '/' + id, function (data) {
    ...
    $("#AddImage").click(function () {
        window.location.href = 'http://laravel0.themes-coder.net/admin/media/addimages';
    });
...
// show_label:   true,
    ...
    $(document).on('click', '.refresh-image', function (e) {
        $("#loader").show();
        $.ajax({
            url: 'http://laravel0.themes-coder.net/admin/media/refresh',
            type: "GET",
            success: function (res) {
                $("#loader").hide();
                if (res.length != '') {
    ...
    $(document).on('click', '#check-password', function (e) {
        ...
        if (password != '') {
            $.ajax({
                url: 'http://laravel0.themes-coder.net/admin/managements/checkpassword',
                type: "post",
...
<?php /**PATH F:\sites\laravel-ecommerce-universal v4.0.12 preinstalled\resources\views/admin/common/newScrips.blade.php ENDPATH**/ ?>