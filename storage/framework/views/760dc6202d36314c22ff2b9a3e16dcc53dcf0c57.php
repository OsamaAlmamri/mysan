<td>
    ...
    <a class="btn btn-warning" style="width: 100%;  margin-bottom: 5px;" href="<?php echo e(url('admin/products/images/display/'. $customers_id)); ?>"><?php echo e(trans('labels.ViewBasketDetails')); ?></a>
    </br>
