<td>
    ...
    <?php endif; ?>
    <a class="btn btn-warning" style="width: 100%;  margin-bottom: 5px;" href="<?php echo e(route('products.images.display',$products_id)); ?>"><?php echo e(trans('labels.ProductImages')); ?></a>
    </br>
