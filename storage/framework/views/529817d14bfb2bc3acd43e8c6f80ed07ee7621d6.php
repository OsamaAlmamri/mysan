                        ...
                        <div class="box-header">
                            ...
                            <div style="margin-right:88px;" class="box-tools pull-left">
                                <button id="btn" type="button"
                                        class="btn btn-block btn-danger"> <?php echo e(trans('labels.delete')); ?></button>

                            </div>
                            <div style="margin-right:162px;" class="box-tools pull-left">
                                <button id="btn11" type="button"
                                        class="btn btn-block btn-success"> <?php echo e(trans('labels.SelectAll')); ?></button>


                            </div>
                            <div style="margin-right:253px;" class="box-tools pull-left">
                                <button id="btn12" type="button"
                                        class="btn btn-block btn-info">  <?php echo e(trans('labels.UnSelectAll')); ?></button>
                                        ...
                                        <?php if($errors->any()): ?>
                                            <div class="alert alert-success alert-dismissible" role="alert">
                                                <button type="button" class="close" data-dismiss="alert"
                                                        aria-label="<?php echo e(trans('labels.Close')); ?>"><span
                                ...
                                <?php if(isset($images)): ?>
                                    <?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <p><a href="<?php echo e(url('admin/media/deleteimage')); ?>/<?php echo e($image->id); ?>"
                                                ...
                                                <img class="test_image" image_id="<?php echo e($image->id); ?>"
                                                     src="<?php echo e(asset($image->path)); ?>" alt="...">
                                            </div>
                                        </div>
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h3 class="modal-title text-primary"
                                id="myModalLabel"><?php echo e(trans('labels.Image Details')); ?></h3>
                        </div>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\sites\mysan\resources\views\admin\media\addimages.blade.php ENDPATH**/ ?>