                    ...
                    <div class="box">
                        <div class="box-header">
                            ...
                            <div class="box-tools pull-right">
                                <a href="<?php echo e(URL::to('admin/addadmins')); ?>" type="button"
                                   class="btn btn-block btn-primary"><?php echo e(trans('labels.addadmins')); ?></a>
                            </div>
                        </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if($admin->isActive==1): ?>
                                                            <strong
                                                                class="badge bg-green"><?php echo e(trans('labels.Active')); ?> </strong>
                                                        <?php else: ?>
                                                            <strong
                                                                class="badge bg-light-grey"><?php echo e(trans('labels.InActive')); ?> </strong>
                                                        <?php endif; ?>
                                                        ...
                                                        <ul class="nav table-nav">
                                                            <li class="dropdown">
                                                                <a class="dropdown-toggle" data-toggle="dropdown"
                                                                   href="#">
                                                                    <?php echo e(trans('labels.Action')); ?> <span
                                                                        class="caret"></span>
                                                                </a>
                                                                <ul class="dropdown-menu">
                                                                    <li role="presentation"><a role="menuitem"
                                                                                               tabindex="-1"
                                                                                               href="editadmin/<?php echo e($admin->id); ?>"><?php echo e(trans('labels.editadmin')); ?></a>
                                                                    </li>
                                                                    <li role="presentation" class="divider"></li>
                                                                    <li role="presentation"><a data-toggle="tooltip"
                                                                                               data-placement="bottom"
                                                                                               title="<?php echo e(trans('labels.Delete')); ?>"
                                                                                               id="deleteCustomerFrom"
                                                                                               customers_id="<?php echo e($admin->id); ?>"><?php echo e(trans('labels.Delete')); ?></a>
                                                                    </li>
                                                                </ul>
                                                            </li>
                                                        </ul>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\sites\mysan\resources\views/admin/admins/index.blade.php ENDPATH**/ ?>