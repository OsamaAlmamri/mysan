    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="<?php echo e(URL::to('admin/manufacturers/display')); ?>"><i class="fa fa-industry"></i> <?php echo e(trans('labels.link_manufacturer')); ?></a></li>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\sites\mysan\resources\views/admin/manufacturers/add.blade.php ENDPATH**/ ?>