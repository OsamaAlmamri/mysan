    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{ URL::to('admin/manageroles')}}"><i
                            class="fa fa-users"></i> {{ trans('labels.manageroles') }}</a></li>
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <!-- form start -->
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                <label for="name"
                                                       class="col-sm-2 col-md-3 control-label">{{ trans('labels.AdminTypeName') }} </label>
                                                <div class="col-sm-10 col-md-4">
                                                    {!! Form::text('user_types_name',  '', array('class'=>'form-control field-validate', 'id'=>'user_types_name')) !!}
                                                    <span class="help-block"
                                                          style="font-weight: normal;font-size: 11px;margin-bottom: 0;">{{ trans('labels.AdminTypeNameText') }}</span>
                                                    <span
                                  ...
                                  {{ trans('labels.AdminTypeStatusText') }}</span>
                                            ...
                                            <div class="box-footer text-center">
                                                ...
                                                <a href="{{ URL::to('admin/manageroles')}}" type="button"
