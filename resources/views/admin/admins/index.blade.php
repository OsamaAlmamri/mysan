                    ...
                    <div class="box">
                        <div class="box-header">
                            ...
                            <div class="box-tools pull-right">
                                <a href="{{ URL::to('admin/addadmins')}}" type="button"
                                   class="btn btn-block btn-primary">{{ trans('labels.addadmins') }}</a>
                            </div>
                        </div>
                                            ...
                                            @foreach ($result['admins']  as $key=>$admin)
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if($admin->isActive==1)
                                                            <strong
                                                                class="badge bg-green">{{trans('labels.Active')}} </strong>
                                                        @else
                                                            <strong
                                                                class="badge bg-light-grey">{{trans('labels.InActive')}} </strong>
                                                        @endif
                                                        ...
                                                        <ul class="nav table-nav">
                                                            <li class="dropdown">
                                                                <a class="dropdown-toggle" data-toggle="dropdown"
                                                                   href="#">
                                                                    {{ trans('labels.Action') }} <span
                                                                        class="caret"></span>
                                                                </a>
                                                                <ul class="dropdown-menu">
                                                                    <li role="presentation"><a role="menuitem"
                                                                                               tabindex="-1"
                                                                                               href="editadmin/{{ $admin->id }}">{{ trans('labels.editadmin') }}</a>
                                                                    </li>
                                                                    ...
                                                                    <li role="presentation"><a data-toggle="tooltip"
                                                                                               ...
                                                                                               customers_id="{{ $admin->id }}">{{ trans('labels.Delete') }}</a>
                                                                    </li>
                                                                </ul>
                                                            </li>
                                                        </ul>
