...
<!-- Tell the browser to be responsive to screen width -->
    ...
    <meta name="theme-color" content="#ffb4b5">
    <!-- Windows Phone -->
    <meta name="msapplication-navbutton-color" content="#ffb4b5">
    <!-- iOS Safari -->
    <meta name="apple-mobile-web-app-status-bar-style" content="#ffb4b5">
    <!-- Bootstrap 3.3.6 -->
    ...
    <!-- Font Awesome -->
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.5.0/css/font-awesome.min.css" media="all"
    ...
    <!-- jvectormap -->
    <link href="{!! asset('admin/plugins/jvectormap/jquery-jvectormap-1.2.2.css') !!} " media="all" rel="stylesheet"
          type="text/css"/>
    <!-- Theme style -->
    ...
    <link href="{!! asset('admin/dist/css/rtl/bootstrap-rtl.min.css')  !!} " media="all" rel="stylesheet"
          type="text/css"/>
    <link href="{!! asset('admin/dist/css/rtl/rtl.css')  !!} " media="all" rel="stylesheet" type="text/css"/>
    <link href="{!! asset('admin/dist/css/rtl/myDashbord.css')  !!} " media="all" rel="stylesheet" type="text/css"/>


    <!-- AdminLTE Skins. Choose a skin from the css/skins
         folder instead of downloading all of them to reduce the load. -->
    <link href="{!! asset('admin/dist/css/skins/_all-skins.css') !!} " media="all" rel="stylesheet" type="text/css"/>
    ...
    <!-- Ionicons -->
    <link href="https://cdnjs.cloudflare.com/ajax/libs/ionicons/2.0.1/css/ionicons.min.css" media="all" rel="stylesheet"
          type="text/css"/>
