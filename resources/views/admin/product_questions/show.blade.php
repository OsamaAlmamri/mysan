    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{ URL::to('admin/product_questions/display')}}"><i
            ...
            <div class="container">
                ...
                <div class="row timeline-movement">
                    ...
                    @if($replay->replay_user_type=='admin')
                        <div class="col-sm-6  timeline-item" id="replay_dev_{{$replay->replay_id}}" style="float: none">
                            <div class="row">
                                <div class="col-sm-11">
                                    <div class="timeline-panel credits">
                                        <a href="#" style="float: left"   data-id="{{$replay->replay_id}}" class="btn_delete_replay"> <i class="fa fa-trash"></i></a>
                                        <a href="#" style="float: left ; margin-left: 8px" class="btn_update_replay"
                                           data-id="{{$replay->replay_id}}"> <i class="fa fa-edit"></i></a>
                                        <ul class="timeline-panel-ul">
                                            <li><span
                                                    class="importo">{{$replay->user->first_name . '  '. $replay->user->last_name}}</span>
                                            </li>
                                            <li><span class="causale"
                                                      id="replay_text_{{$replay->replay_id}}">{{$replay->text}} </span>
                                            </li>
                    ...
                    @else
                        <div style="float: none" id="replay_dev_{{$replay->replay_id}}" class="col-sm-offset-6 col-sm-6 timeline-item">
                            <div class="row">
                                <div class="col-sm-offset-1 col-sm-11">
                                    <div class="timeline-panel debits">
                                        <a href="#" style="float: right"   data-id="{{$replay->replay_id}}" class="btn_delete_replay"> <i class="fa fa-trash"></i></a>
    ...
    <div class="modal fade" id="replayModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <input type="hidden" id="ques_ques_id" value="{{$productQuestion->product_question_id}}">
