...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1> {{ trans('labels.Bouquets') }} <small>{{ trans('labels.Add Bouquet') }}...</small> </h1>
        <ol class="breadcrumb">
            <li><a href="{{ URL::to('admin/dashboard/this_month') }}"><i class="fa fa-dashboard"></i> {{ trans('labels.breadcrumb_dashboard') }}</a></li>
            <li><a href="{{ URL::to('admin/bouquets/display')}}"><i class="fa fa-database"></i>{{ trans('labels.Bouquets') }}</a></li>
                            ...
                            <div class="col-xs-12">
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        ...
                                        {!! Form::open(array('url' =>'admin/bouquets/add', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
