            ...
            <div class="newsletter">
                ...
                <div class="block">
                  <form class="form-inline mailchimp-form" action="{{url('subscribeMail')}}" >
                        <div class="search">
                          <input type="email" name="email" class="email" id="email" placeholder="@lang('website.Your email address here')">                            
                            <button type="submit" class="btn-secondary fas fa-location-arrow newsletter">
                            </button>
